...
def upgrade() -> None:
    ...
    op.create_table('commission_monthly',
    ...
    # Create indexes
    op.create_index('ix_commission_monthly_follower_id', 'commission_monthly', ['follower_id'], unique=False)
    op.create_index('ix_commission_monthly_follower_period', 'commission_monthly', ['follower_id', 'year', 'month'], unique=False)
    op.create_index('ix_commission_monthly_period', 'commission_monthly', ['year', 'month'], unique=False)
    op.create_index('ix_commission_monthly_payable', 'commission_monthly', ['is_payable'], unique=False)
