...
class TestNotifierMinIO:
    ...
    def test_send_with_minio_success(self, mock_config, mock_send_email, mock_minio, mock_follower, test_files):
        ...
        mock_minio.upload_report_with_url.side_effect = [
            ("reports/2025-05/test-follower-123/report_2025-05.pdf", "https://minio.example.com/pdf-url"),
            ("reports/2025-05/test-follower-123/report_2025-05.xlsx", "https://minio.example.com/excel-url")
        ]
    ...
    @patch('app.service.notifier_minio.send_email')
    @patch('app.service.notifier_minio.config')
    def test_send_fallback_to_attachments(self, mock_config, mock_send_email, mock_minio, mock_follower, test_files):
    ...
    @patch('app.service.notifier_minio.send_email')
    @patch('app.service.notifier_minio.config')
    def test_send_email_failure(self, mock_config, mock_send_email, mock_minio, mock_follower, test_files):
    ...
    @patch('app.service.notifier_minio.send_email')
    @patch('app.service.notifier_minio.config')
    def test_partial_minio_upload(self, mock_config, mock_send_email, mock_minio, mock_follower, test_files):
