...
class TestVerticalSpreadsStrategyHandler(unittest.TestCase):
    ...
    async def test_process_signal(self, mock_get_ny_time):
        ...
        self.handler._place_vertical_spread = AsyncMock(return_value={"status": "FILLED", "fill_price": 0.75})
    ...
    async def test_calculate_time_value(self):
        ...
        self.handler.ibkr_client.get_market_price = AsyncMock(side_effect=[1.50, 390.0])  # Option price, underlying price
        ...
        self.handler.ibkr_client.get_market_price.side_effect = [1.50, 370.0]  # Option price, underlying price
