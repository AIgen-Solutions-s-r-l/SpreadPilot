...
from ib_insync import Contract, Order, BarData, Stock
...
MOCK_BAR_DATA = [
    BarData(date=datetime.datetime(2025, 4, 18, 10, 0, 0), open=20.0, high=21.0, low=19.0, close=20.5, volume=1000, average=20.2, barCount=100),
    BarData(date=datetime.datetime(2025, 4, 18, 10, 5, 0), open=20.5, high=21.5, low=20.0, close=21.0, volume=1200, average=20.8, barCount=120),
]

MOCK_HISTORICAL_DF = pd.DataFrame([
    {'time': datetime.datetime(2025, 4, 18, 9, 30, 0), 'open': 20.0, 'high': 21.0, 'low': 19.0, 'close': 20.0, 'volume': 1000},
    {'time': datetime.datetime(2025, 4, 18, 9, 35, 0), 'open': 20.0, 'high': 21.0, 'low': 19.0, 'close': 20.5, 'volume': 1100},
    {'time': datetime.datetime(2025, 4, 18, 9, 40, 0), 'open': 20.5, 'high': 21.5, 'low': 20.0, 'close': 21.0, 'volume': 1200},
    {'time': datetime.datetime(2025, 4, 18, 9, 45, 0), 'open': 21.0, 'high': 22.0, 'low': 20.5, 'close': 21.5, 'volume': 1300},
    {'time': datetime.datetime(2025, 4, 18, 9, 50, 0), 'open': 21.5, 'high': 22.5, 'low': 21.0, 'close': 22.0, 'volume': 1400},
    {'time': datetime.datetime(2025, 4, 18, 9, 55, 0), 'open': 22.0, 'high': 23.0, 'low': 21.5, 'close': 22.5, 'volume': 1500},
    {'time': datetime.datetime(2025, 4, 18, 10, 0, 0), 'open': 22.5, 'high': 23.5, 'low': 22.0, 'close': 23.0, 'volume': 1600},
    {'time': datetime.datetime(2025, 4, 18, 10, 5, 0), 'open': 23.0, 'high': 24.0, 'low': 22.5, 'close': 23.5, 'volume': 1700},
    {'time': datetime.datetime(2025, 4, 18, 10, 10, 0), 'open': 23.5, 'high': 24.5, 'low': 23.0, 'close': 24.0, 'volume': 1800},
    {'time': datetime.datetime(2025, 4, 18, 10, 15, 0), 'open': 24.0, 'high': 25.0, 'low': 23.5, 'close': 24.5, 'volume': 1900},
    {'time': datetime.datetime(2025, 4, 18, 10, 20, 0), 'open': 24.5, 'high': 25.5, 'low': 24.0, 'close': 25.0, 'volume': 2000},
    {'time': datetime.datetime(2025, 4, 18, 10, 25, 0), 'open': 25.0, 'high': 26.0, 'low': 24.5, 'close': 25.5, 'volume': 2100},
    {'time': datetime.datetime(2025, 4, 18, 10, 30, 0), 'open': 25.5, 'high': 26.5, 'low': 25.0, 'close': 26.0, 'volume': 2200},
    {'time': datetime.datetime(2025, 4, 18, 10, 35, 0), 'open': 26.0, 'high': 27.0, 'low': 25.5, 'close': 26.5, 'volume': 2300},
    {'time': datetime.datetime(2025, 4, 18, 10, 40, 0), 'open': 26.5, 'high': 27.5, 'low': 26.0, 'close': 27.0, 'volume': 2400},
    {'time': datetime.datetime(2025, 4, 18, 10, 45, 0), 'open': 27.0, 'high': 28.0, 'low': 26.5, 'close': 27.5, 'volume': 2500},
    {'time': datetime.datetime(2025, 4, 18, 10, 50, 0), 'open': 27.5, 'high': 28.5, 'low': 27.0, 'close': 28.0, 'volume': 2600},
    {'time': datetime.datetime(2025, 4, 18, 10, 55, 0), 'open': 28.0, 'high': 29.0, 'low': 27.5, 'close': 28.5, 'volume': 2700},
    {'time': datetime.datetime(2025, 4, 18, 11, 0, 0), 'open': 28.5, 'high': 29.5, 'low': 28.0, 'close': 29.0, 'volume': 2800},
    {'time': datetime.datetime(2025, 4, 18, 11, 5, 0), 'open': 29.0, 'high': 30.0, 'low': 28.5, 'close': 29.5, 'volume': 2900},
    {'time': datetime.datetime(2025, 4, 18, 11, 10, 0), 'open': 29.5, 'high': 30.5, 'low': 29.0, 'close': 30.0, 'volume': 3000},
    {'time': datetime.datetime(2025, 4, 18, 11, 15, 0), 'open': 30.0, 'high': 31.0, 'low': 29.5, 'close': 30.5, 'volume': 3100},
])
...
async def strategy_handler(mock_trading_service, mock_ibkr_client):
    ...
    with patch('trading_bot.app.service.original_strategy_handler.IBKRClient', return_value=mock_ibkr_client):
        ...
        handler.historical_data = {"SOXS": MOCK_HISTORICAL_DF.copy(), "SOXL": MOCK_HISTORICAL_DF.copy()}
        yield handler
...
def test_calculate_ema(strategy_handler):
    ...
    assert fast_ema.iloc[-1] < series.iloc[-1]  # EMA should be less than the last price in an uptrend
    assert slow_ema.iloc[-1] < fast_ema.iloc[-1]  # Slow EMA should lag behind fast EMA in an uptrend
...
async def test_process_bar_bullish_crossover(strategy_handler, mock_ibkr_client):
    ...
    bar = BarData(
        ...
        open=31.0, high=32.0, low=30.5, close=31.5,
        volume=3200, average=31.2, barCount=150
    )
