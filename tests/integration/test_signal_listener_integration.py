...
class TestSignalListenerIntegration:
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_signal_processing(
        self, signal_listener_with_fake_redis, mock_gsheet_setup, fake_redis
    ):
    ...
    @pytest.mark.asyncio
    async def test_redis_connection_and_publish(
        self, signal_listener_with_fake_redis, fake_redis
    ):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_gsheet_failure(
        self, signal_listener_with_fake_redis, fake_redis
    ):
        ...
        with patch(
            "gspread.service_account", side_effect=Exception("GSheet connection failed")
        ):
    ...
    @pytest.mark.asyncio
    async def test_multiple_date_rows_in_sheet(
        self, signal_listener_with_fake_redis, mock_gsheet_setup
    ):
    ...
    @pytest.mark.asyncio
    async def test_malformed_sheet_data_handling(
        self, signal_listener_with_fake_redis, mock_gsheet_setup
    ):
    ...
    @pytest.mark.asyncio
    async def test_timezone_aware_signal_timestamp(
        self, signal_listener_with_fake_redis
    ):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_polling_simulation(
        self, signal_listener_with_fake_redis, mock_gsheet_setup
    ):
