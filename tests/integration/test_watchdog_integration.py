...
class TestWatchdogIntegration:
    ...
    @pytest.mark.asyncio
    async def test_healthy_service_monitoring(self, mock_docker_client, dummy_container, fake_redis):
    ...
    @pytest.mark.asyncio
    async def test_service_failure_and_restart(self, mock_docker_client, dummy_container, fake_redis):
    ...
    @pytest.mark.asyncio
    async def test_service_recovery_after_failures(self, mock_docker_client, dummy_container, fake_redis):
    ...
    @pytest.mark.asyncio
    async def test_restart_failure_critical_alert(self, mock_docker_client, dummy_container, fake_redis):
