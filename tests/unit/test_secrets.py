...
from spreadpilot_core.utils.secrets import get_secret_from_mongo, SECRETS_COLLECTION_NAME
...
async def test_get_secret_db_error(mock_db):
    ...
    mock_db[SECRETS_COLLECTION_NAME].find_one.side_effect = Exception("Simulated DB Connection Error")
