...
from spreadpilot_core.utils.vault import VaultClient, get_vault_client, get_ibkr_credentials_from_vault
...
class TestVaultClient:
    ...
    def test_put_secret_failure(self, mock_hvac_client):
        ...
        mock_client_instance = Mock()
        mock_client_instance.is_authenticated.return_value = True
        mock_client_instance.secrets.kv.v2.create_or_update_secret.side_effect = Exception("Vault error")
        mock_hvac_client.return_value = mock_client_instance
