...
class TestSettingsIntegrationWithOriginalStrategy:
    ...
    def test_original_strategy_vault_integration(self, mock_get_vault_client):
        ...
        result = settings.get_ibkr_credentials_from_vault(ORIGINAL_EMA_STRATEGY["ibkr_secret_ref"])
        
        # Assert
        assert result == {"IB_USER": "original_user", "IB_PASS": "original_pass"}
        mock_vault_client.get_ibkr_credentials.assert_called_once_with("ibkr_original_strategy")
    ...
    def test_vertical_spreads_strategy_vault_integration(self, mock_get_vault_client):
        ...
        result = settings.get_ibkr_credentials_from_vault(VERTICAL_SPREADS_STRATEGY["ibkr_secret_ref"])
        
        # Assert
        assert result == {"IB_USER": "spreads_user", "IB_PASS": "spreads_pass"}
        mock_vault_client.get_ibkr_credentials.assert_called_once_with("ibkr_vertical_spreads_strategy")
