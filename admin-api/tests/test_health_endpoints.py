...
class TestHealthEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_health_green_status(self, mock_auth, mock_db, mock_psutil, mock_httpx):
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_health_yellow_status(self, mock_auth, mock_db, mock_psutil, mock_httpx):
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_health_red_status_critical_service(self, mock_auth, mock_db, mock_psutil, mock_httpx):
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_health_red_status_system_resources(self, mock_auth, mock_db, mock_psutil, mock_httpx):
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_health_database_unhealthy(self, mock_auth, mock_psutil, mock_httpx):
