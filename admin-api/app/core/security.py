...
class PINVerification:
    ...
    def __init__(self):
        ...
        self.pin_created_at: Optional[datetime] = None
        ...
        if self.pin_created_at:
            ...
            if days_old > PIN_EXPIRY_DAYS:
                raise HTTPException(
                    ...
                    detail=f"PIN expired. Please set a new PIN."
                )
    ...
    def _record_failed_attempt(self, user_id: str) -> None:
        ...
        pin_attempts[user_id] = [
            attempt for attempt in pin_attempts[user_id]
            if attempt > cutoff
        ]
...
async def verify_dangerous_operation(
    ...
    x_pin: Optional[str] = Header(None, description="PIN for dangerous operations"),
