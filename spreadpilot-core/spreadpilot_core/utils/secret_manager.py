...
SECRET_CONFIGS = {
    ...
    SecretType.JWT_SECRET: SecretConfig(
        vault_path="secret/spreadpilot/auth/jwt", env_var="JWT_SECRET", required=True
    ),
    ...
    SecretType.ADMIN_PASSWORD_HASH: SecretConfig(
        vault_path="secret/spreadpilot/auth/admin", env_var="ADMIN_PASSWORD_HASH", required=True
    ),
    SecretType.SECURITY_PIN_HASH: SecretConfig(
        vault_path="secret/spreadpilot/auth/security", env_var="SECURITY_PIN_HASH", required=True
    ),
    # Database
    ...
    SecretType.POSTGRES_URI: SecretConfig(
        vault_path="secret/spreadpilot/database/postgres", env_var="DATABASE_URL", required=False
    ),
    ...
    SecretType.SMTP_USER: SecretConfig(
        vault_path="secret/spreadpilot/email/smtp", env_var="SMTP_USER", required=False
    ),
    SecretType.SMTP_PASSWORD: SecretConfig(
        vault_path="secret/spreadpilot/email/smtp", env_var="SMTP_PASSWORD", required=False
    ),
    SecretType.SMTP_URI: SecretConfig(
        vault_path="secret/spreadpilot/email/smtp", env_var="SMTP_URI", required=False
    ),
    # Cloud Storage
    SecretType.MINIO_ACCESS_KEY: SecretConfig(
        vault_path="secret/spreadpilot/storage/minio", env_var="MINIO_ACCESS_KEY", required=False
    ),
    SecretType.MINIO_SECRET_KEY: SecretConfig(
        vault_path="secret/spreadpilot/storage/minio", env_var="MINIO_SECRET_KEY", required=False
    ),
    ...
    SecretType.IB_USER: SecretConfig(
        vault_path="secret/spreadpilot/ibkr/credentials", env_var="IB_USER", required=True
    ),
    SecretType.IB_PASS: SecretConfig(
        vault_path="secret/spreadpilot/ibkr/credentials", env_var="IB_PASS", required=True
    ),
}
...
class SecretManager:
    ...
    def get_database_config(self) -> dict[str, Optional[str]]:
        ...
        return self.get_secret_dict(
            SecretType.MONGO_URI, SecretType.POSTGRES_URI, SecretType.REDIS_URL
        )
    ...
    def get_email_config(self) -> dict[str, Optional[str]]:
        ...
        return self.get_secret_dict(
            SecretType.SMTP_USER, SecretType.SMTP_PASSWORD, SecretType.SMTP_URI
        )
